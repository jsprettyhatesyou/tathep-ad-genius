  ...
  return (
    <Labeled label={label} required={required} className={className}>
      <input
        ...
        className="h-9 w-full rounded-lg border border-input bg-white px-3 text-sm focus:border-fresco focus:outline-none focus:ring-2 focus:ring-lake/30"
      />
    </Labeled>
  );
}
  ...
  return (
    <Labeled label={label} className={className}>
      <textarea
        ...
        onChange={(e) => onChange(e.target.value)}
        placeholder={placeholder}
        className="w-full rounded-lg border border-input bg-white p-2 text-sm focus:border-fresco focus:outline-none focus:ring-2 focus:ring-lake/30"
      />
    </Labeled>
  );
}
...
export function GroupedCombobox({
  ...
  const trigger = (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button type="button" variant="outline" role="combobox" aria-expanded={open} className="h-9 w-full justify-between bg-white font-normal">
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className={cn("h-9 w-full justify-between bg-white font-normal", selected.length > 0 && "border-fresco/40 text-fresco")}
          >
